...
$roles=['Owner / Admin'=>null,'Branch Manager'=>['dashboard','shift','pos','tablet','kds','tables','orders','online','inventory','purchasing','po','recipe','menu','wastage','transfer','count','suppliers','customers','delivery','riders','reservations','loyalty','expenses','accounting','promotions','void','reports','fbr','printers','offline','users','settings'],/* V78 — Cashier ko sirf apna kaam.
