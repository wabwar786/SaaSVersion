...
$scripts = @(
  ...
  'migrate_menu_image','migrate_branding','migrate_qr_orders','migrate_devices','migrate_shifts','migrate_sync_columns','migrate_sync_log','migrate_delete_support','migrate_print_rule_default','migrate_fiscal','migrate_security','migrate_modules','migrate_role_scope','demo_reset',
