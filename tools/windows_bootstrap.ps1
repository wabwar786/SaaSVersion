...
try {
    ...
    foreach($script in @("seed_roles.php","seed_suppliers.php","seed_edge_node.php","seed_restaurant_demo.php","migrate_error_log.php","seed_node_owner.php","ensure_v13_login.php","licence_enforce.php","migrate_sync.php","migrate_platform.php","migrate_bridge.php","migrate_collation.php","migrate_site_defaults.php","migrate_ui_menu.php","migrate_menu_image.php","migrate_branding.php","migrate_qr_orders.php","migrate_devices.php","migrate_shifts.php","migrate_sync_columns.php","migrate_sync_log.php","migrate_security.php","migrate_module_ids.php","migrate_retail.php","seed_industry_modules.php")) {
