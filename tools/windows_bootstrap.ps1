...
try {
    ...
    foreach($script in @("seed_roles.php","seed_suppliers.php","seed_edge_node.php","seed_restaurant_demo.php","ensure_v13_login.php","migrate_sync.php","migrate_platform.php")) {
