...
(function () {
  ...
  var defaults = {
    ...
    products: [
      { id: 'p1', sku: 'GRO-0001', name: 'Falak Super Basmati Rice 5 KG', barcodes: ['8964000112233'], department_id: 'd1', category_id: 'c1', brand_id: 'b1', base_unit_id: 'u1', tax_rate: 0, cost_price: 2180, retail_price: 2450, wholesale_price: 2320, mrp: 2500, stock_qty: 46, min_stock: 12, max_stock: 80, is_scale_item: 0, plu_code: '', track_batch: 0, shelf_life_days: 540, status: 'Active' },
      { id: 'p2', sku: 'GRO-0002', name: 'Dalda Cooking Oil 5 Litre', barcodes: ['8964000445566'], department_id: 'd1', category_id: 'c2', brand_id: 'b2', base_unit_id: 'u1', tax_rate: 17, cost_price: 2680, retail_price: 2975, wholesale_price: 2840, mrp: 3050, stock_qty: 31, min_stock: 10, max_stock: 60, is_scale_item: 0, plu_code: '', track_batch: 1, shelf_life_days: 365, status: 'Active' },
      { id: 'p3', sku: 'GRO-0003', name: 'Tapal Danedar Tea 950 G', barcodes: ['8964000778899'], department_id: 'd1', category_id: 'c3', brand_id: 'b3', base_unit_id: 'u1', tax_rate: 17, cost_price: 1420, retail_price: 1590, wholesale_price: 1510, mrp: 1625, stock_qty: 8, min_stock: 15, max_stock: 50, is_scale_item: 0, plu_code: '', track_batch: 0, shelf_life_days: 730, status: 'Active' },
      { id: 'p4', sku: 'DAI-0001', name: 'Olpers Milk 1 Litre', barcodes: ['8964000221144'], department_id: 'd3', category_id: 'c6', brand_id: 'b5', base_unit_id: 'u1', tax_rate: 0, cost_price: 268, retail_price: 300, wholesale_price: 285, mrp: 310, stock_qty: 96, min_stock: 40, max_stock: 200, is_scale_item: 0, plu_code: '', track_batch: 1, shelf_life_days: 90, status: 'Active' },
      { id: 'p5', sku: 'BEV-0001', name: 'Coca-Cola 1.5 Litre', barcodes: ['5449000054227', '8964000990011'], department_id: 'd5', category_id: 'c9', brand_id: 'b6', base_unit_id: 'u1', tax_rate: 17, cost_price: 168, retail_price: 200, wholesale_price: 182, mrp: 210, stock_qty: 142, min_stock: 48, max_stock: 288, is_scale_item: 0, plu_code: '', track_batch: 0, shelf_life_days: 180, status: 'Active' },
    ...
    product_uom: [
      ...
      { id: 'pu2', product_id: 'p12', unit_id: 'u7', barcode: '8964000101027', factor: 24, cost_price: 1440, retail_price: 1920, is_default_purchase: 1 },
      { id: 'pu3', product_id: 'p4', unit_id: 'u8', barcode: '8964000221151', factor: 12, cost_price: 3180, retail_price: 3480, is_default_purchase: 1 },
      { id: 'pu4', product_id: 'p9', unit_id: 'u6', barcode: '8964000667795', factor: 12, cost_price: 1380, retail_price: 1620, is_default_purchase: 1 }
    ],
